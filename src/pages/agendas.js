	...
	return (
		<div className="flex items-center justify-center w-full ">
			...
			<div className="w-[70%] space-y-8">
				...
				{agendas.map((agenda) => {
					return (
						<a key={agenda.date} href={agenda.link} target="_blank" rel="noreferrer" className="block p-6 space-y-4 transition-all duration-300 rounded-2xl hover:bg-gray-800 hover:scale-[1.02] hover:shadow-lg ring-purple-300 ring-1">
